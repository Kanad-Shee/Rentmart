          ...
          >
            <div>
              ...
              <p className="mt-5 max-w-md text-lg leading-8 text-muted-foreground">
                Have a question about a rental or need help listing your machinery?
                Reach out to our team.
              </p>

              <div className="mt-10 space-y-7">
                {contactLinks.map(({ label, value, meta, icon: Icon, href }) => (
                  <a
                    key={label}
                    href={href}
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-7 text-muted-foreground">
                  Support queries can be submitted only by owner and renter accounts.
                  We use your logged-in profile details automatically.
                </p>
              </div>
            </div>
                ...
                <div className="flex items-start gap-3 text-[#8b3f1f]">
                  ...
                  <div>
                    <p className="text-sm font-semibold">
                      Admin accounts can review support queries but cannot create them.
                    </p>
                    <p className="mt-2 text-sm leading-7">
                      Please use an owner or renter account if you need to submit a
            ...
            <form onSubmit={form.handleSubmit(handleSubmit)} className="mt-8 space-y-5">
              ...
              <Field data-invalid={!!form.formState.errors.topic}>
                <FieldLabel htmlFor="contact-topic">How can we help?</FieldLabel>
                <select
                  id="contact-topic"
              ...
              <Field data-invalid={!!form.formState.errors.message}>
                ...
                />
                <FieldDescription>
                  We store support queries securely in the admin queue for review.
                </FieldDescription>
              ...
              {submitNotice ? (
                <p className="text-sm font-medium text-primary">{submitNotice}</p>
              ) : null}
