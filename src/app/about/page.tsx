...
const ownerSteps = [
  {
    ...
    body:
      "Upload photos, add commercial specs, define delivery coverage, and publish an equipment page that gives renters the details they need to book with confidence.",
  },
  {
    step: "STEP 02",
    ...
    body:
      "Review incoming rental requests from verified businesses, confirm scheduling, and rely on Rentmart checks to keep identity, communication, and job expectations clear before handoff.",
  },
  {
    step: "STEP 03",
    ...
    body:
      "Secure escrow handling and milestone-based releases help owners avoid payment friction while keeping every rental traceable from confirmation through completion.",
  },
] as const;
...
const renterSteps = [
  {
    ...
    body:
      "Filter by category, price, availability, and distance to find the right equipment near your project site without waiting on long procurement cycles or uncertain callbacks.",
  },
  {
    step: "STEP 02",
    ...
    body:
      "Coordinate pickup or delivery, document machine condition, and keep both parties aligned on timing, site access, and operating readiness before work begins.",
  },
  {
    step: "STEP 03",
    ...
    body:
      "Use dependable equipment to keep the job moving, then close out the rental with a transparent return flow and review system that strengthens future trust.",
  },
] as const;
...
const trustHighlights = [
  {
    ...
    body:
      "Every eligible rental is backed by protection designed for high-value machines, giving both owners and renters an added layer of operational confidence.",
    accent: "Protection",
    icon: ShieldCheck,
    className:
  ...
  },
  {
    ...
    body:
      "Structured handoff notes, equipment details, and documented machine condition help both parties stay aligned before delivery, during use, and at return.",
    accent: "Clear Handoffs",
    icon: ClipboardCheck,
    className:
      "bg-[#efefeb] text-foreground border-border",
  },
  {
    title: "Secure Escrow Payments",
    body:
      "Funds stay protected during the booking journey and are released according to platform rules after a successful rental handoff and completion.",
    accent: "Escrow Ready",
    icon: Banknote,
    className:
      "bg-[#efefeb] text-foreground border-border",
  },
  {
    ...
    body:
      "Our support team is available when scheduling changes, handoff issues, or active-rental questions need a fast and professional response.",
    accent: "Always Available",
    icon: Headset,
    className:
      "md:col-span-2 bg-[#efefeb] text-foreground border-border",
  },
] as const;
  ...
  return (
    <motion.div
      className={[
        ...
        reverse ? "md:grid-cols-[1.05fr_0.95fr]" : "md:grid-cols-[0.95fr_1.05fr]",
      ].join(" ")}
        ...
        <div className="mx-auto max-w-7xl px-6 py-10 lg:px-8">
          ...
          <div className="grid gap-14 py-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:items-center lg:py-16">
            <motion.div {...getRevealProps(shouldReduceMotion, 1)}>
              <SectionEyebrow>Built For Modern Equipment Sharing</SectionEyebrow>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-3 text-sm leading-7 text-muted-foreground sm:text-base">
              The protections that make equipment rentals feel more professional,
              more transparent, and easier to scale.
            </p>
          </motion.div>

          <div className="mt-12 grid gap-4 md:grid-cols-3">
            {trustHighlights.map(({ title, body, accent, icon: Icon, className }, index) => (
              <motion.article
                key={title}
                className={[
